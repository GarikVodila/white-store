      ...
      <Swiper
        ...
        <div className="firlter-row">
          <div className="brend__type-row">
              <label className="brend__type-name" htmlFor="category">Вид дрехи:</label>
              ...
              >
                  ...
                  <option className="brend__type-item" value="shoose">Обувки</option>
        ...
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product) => (
            <div className="catalog__item" key={product.id}>
                ...
                <a href="https://t.me/managerWhitestore" target="blank" className="catalog__item-btn">Поръчка</a>
            </div>
          ))
        ) : (
