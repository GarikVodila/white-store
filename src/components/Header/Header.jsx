                ...
                <div className="header__container">
                    ...
                    <div className="header__menu">
                        ...
                        <div className="header__menu__lang">
                            <a href="/bl" className="header__menu__lang-item">BUL <Bul className="header__menu__lang-icon"></Bul></a>
                            <a href="/eg" className="header__menu__lang-item">ENG <Uk className="header__menu__lang-icon"></Uk></a>
                        </div>
                    </div>
                </div>
