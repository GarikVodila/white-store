                ...
                <div className="footer__container">
                    <div className="footer__infoBox">
                        ...
                        <div className="footer__infoBox__item">
                            ...
                            <p className="footer__infoBox-text">Твой интернет магазин, где ты можешь взять оригинальные вещи, по цене с Америки, с бесплатной доставкой и в кратчайшие сроки товар оказывается у вас. Сервис сделан для клиентов с максимальным удобством и качеством, наши менеджери с радость ответят на ваши вопросы.</p>
                        </div>
                    </div>
